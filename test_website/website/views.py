...
def daily_report(request):
    ...
    return render(request, 'index.html', {'reports': reports, 'today': today})
...
def daily_create(request):
    ...
    return render(request, 'daily_report_form.html', {'form': form})
...
def daily_report_by_date(request, year, month, day):
    ...
    return render(request, 'daily_report_by_date.html', {'reports': reports, 'date': date})
...
def view_reports_by_date(request):
    if request.method == 'POST':
        ...
        return render(request, 'daily_report_by_date.html', {'reports': reports, 'report_date': report_date})
    else:
        return render(request, 'daily_report_by_date.html')
...
def summary_report_second(request):
    if request.method == 'POST':
        ...
        return render(request, 'summary_report.html', {'reports': reports, 'total_sum': total_sum})
    else:
        return render(request, 'summary_report.html')